...
namespace DeckForge.GameConstruction.PresetGames.Poker
{
    ...
    /// </summary>
    public class EvaluateRoundWinnerAction : BaseGameAction
    {
        private readonly PokerGameMediator pGM;

        /// <summary>
        /// Initializes a new instance of the <see cref="EvaluateRoundWinnerAction"/> class.
        /// </summary>
        /// <param name="pGM"><see cref="PokerGameMediator"/> that is in charge of running the game.</param>
        /// <param name="name">Name of the action.</param>
        /// <param name="description">Description of the action.</param>
        public EvaluateRoundWinnerAction(
