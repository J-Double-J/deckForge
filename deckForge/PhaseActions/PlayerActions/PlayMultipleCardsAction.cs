...
{
    /// <summary>
    /// Lets the <see cref="IPlayer"/> to play a number of <see cref="Card"/>s.
    /// </summary>
    public class PlayMultipleCardsAction : PlayerGameAction
    {
        ...
        /// </summary>
        /// <param name="playCount">Number of <see cref="Card"/>s that the action lets
        ...
        /// <summary>
        /// Gets or sets the number of <see cref="Card"/>s the action lets
